...
//         hamburgerMenu.classList.toggle('active'); // Optional: Add class to animate hamburger
//     });

//     // Close sidebar when a link is clicked (for smoother UX)
...
//         if (sidebar.classList.contains('open') && window.innerWidth > 900) { // Assuming 900px is the breakpoint for sidebar
//             sidebar.classList.remove('open');
//             hamburgerMenu.classList.remove('active');
//         }
//     });
